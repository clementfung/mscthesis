...
\title{Dancing in the Dark: Private Multi-Party Machine Learning in an Untrusted Setting}
%\subtitle{If you want a subtitle}

\author{Clement Fung}
\previousdegree{BASc., University of Waterloo, 2016}
...
\faculty{The Faculty of Computer Science}
\department{Science}
...
%% files
\hypersetup{
  pdftitle={Dancing in the Dark: Private Multi-Party Machine Learning in an Untrusted Setting (DRAFT: \today)},
  pdfauthor={Clement Fung},
  pdfkeywords={Machine Learning, Distributed Systems, Security, 
  Privacy, Anonymity}
}
